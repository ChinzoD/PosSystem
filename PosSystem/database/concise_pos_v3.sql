...
--
-- Host: localhost
-- Generation Time: Oct 27, 2016 at 12:13 AM
...
INSERT INTO `authorities` (`id`, `authority`, `userId`) VALUES
(4, 'ROLE_ADMIN', 1),
(5, 'ROLE_ADMIN', 2);
...
INSERT INTO `user` (`userId`, `username`, `password`, `verifyPassword`, `firstName`, `lastName`, `gender`, `email`, `enabled`) VALUES
(1, 'chinzo', '$2a$10$y7.4gZeuyMoRNYz5tUUm/OODDarshbTPRXg60MhPCA7f5kCvejz0u', NULL, 'chinzo', 'dandar', 1, 'chinzorig@gmail.com', 1),
(2, 'tamrat', '$2a$10$eexmCGxYVZQYYNNVd/qC6OHTQ/wdEItzpFrkDjOnq3bhV4ri/YfdO', NULL, 'tamrat', 'tamrat', 1, 'tamrat@gmail.com', 1);
